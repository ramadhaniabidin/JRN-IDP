...
function PopUp_ShowDialogHeader(shownPopup, module, currentRow) {
    ...
    if (module == "UnloadingFee") {
        ...
        options = [
            ...
            { value: "Vendor_Number", name: "Vendor_Number" },
        ...
        trgtID = ["VendorName", "VendorNumber"];
        trgtCol = ["Vendor_Name", "Vendor_Number"];
    }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(jsonData.Logs, function (key, values) {
                ...
                colFour.setAttribute("style", "text-align:center;cursor:pointer;color: blue; text-decoration: none; padding: 0 1px");
