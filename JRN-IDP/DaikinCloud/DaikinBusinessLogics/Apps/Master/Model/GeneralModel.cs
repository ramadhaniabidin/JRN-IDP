...
namespace Daikin.BusinessLogics.Apps.Master.Model
{
    ...
    public class GeneralHeaderModel
    {
        ...
        public string BP_Grouping { get; set; }
        ...
        public string PAL_Number { get; set; }
        public int PAL_Item_ID { get; set; }
        ...
        public string QCF_URL { get; set; }
        public string PO_URL { get; set; }
        public string PO_RELEASE_URL { get; set; }
        public string CT_URL { get; set; }
